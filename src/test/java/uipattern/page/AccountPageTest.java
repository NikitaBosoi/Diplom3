...
//        System.setProperty("webdriver.chrome.driver","C:\Users\adm\WebDriver\bin\\yandexdriver.exe");
    ...
    public void testGoToConstructor() throws InterruptedException {
        ...
        assertTrue(objMainPage.getActualText(objMainPage.makeBurger).contains("Соберите бургер"));
    }
    ...
    public void testLogoutUser() throws InterruptedException {
        InAccount();
        WaitForLoad.waitForLoadXpath(objAccountPage.logout);
        objAccountPage.clickLogout();
        Thread.sleep(1000);
        assertTrue(objLoginPage.getActualText(objLoginPage.registrationLogin).contains("Войти"));
    }
