...
//        System.setProperty("webdriver.chrome.driver","C:\Users\adm\WebDriver\bin\\yandexdriver.exe");
    ...
    public void testGoToSauce() {
        ...
        MatcherAssert.assertThat(objMainPage.getElementClassName(objMainPage.section, 1), containsString("current"));
    }
    ...
    public void testGoToFilling() {
        ...
        MatcherAssert.assertThat(objMainPage.getElementClassName(objMainPage.section, 2), containsString("current"));
    }
    ...
    public void testGoToBuns() {
        ...
        MatcherAssert.assertThat(objMainPage.getElementClassName(objMainPage.section, 0), containsString("current"));
    }
    ...
    public void testGoToPersonalAccount() throws InterruptedException {
        ...
        objMainPage.clickPersonalAccount();
        WaitForLoad.waitForLoadXpath(objAccountPage.userAccount);
        assertTrue(objAccountPage.getActualText(objAccountPage.userAccount).contains("В этом разделе вы можете изменить свои персональные данные"));
    }
